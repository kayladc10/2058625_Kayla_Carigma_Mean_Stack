...
let productAdd: any[] = [];     //create array for input of product info
let totalCost:number=0;         //create variable for total cost amount 
let quantityAmount:number=0;          //create counter for quantity
let productNumber=-1;
...
function addToCart(id:string){
    ...
    if(id == "blueberryprod"){
        ...
        productQuantity = Number((document.getElementById("blueberryqty") as HTMLInputElement).value);
        productPrice = 14.00;
        productNumber += 1;
        ...
        productQuantity = Number((document.getElementById("cherryqty") as HTMLInputElement).value);
        productPrice = 13.75;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
        ...
        productQuantity = Number((document.getElementById("lemonqty") as HTMLInputElement).value);
        productPrice = 16.00;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    } else if (id == "shooflyprod"){
        productName = document.getElementById("shooflyname").textContent;
        productQuantity = Number((document.getElementById("shooflyqty") as HTMLInputElement).value);
        productPrice = 12.50;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    } else if (id == "peachprod") {
        productName = document.getElementById("peachname").textContent;
        productQuantity = Number((document.getElementById("peachqty") as HTMLInputElement).value);
        productPrice = 15.50;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    } else if (id == "pumpkinprod") {
        productName = document.getElementById("pumpkinname").textContent;
        productQuantity = Number((document.getElementById("pumpkinqty") as HTMLInputElement).value);
        productPrice = 11.30;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    } else if (id == "appleprod") {
        productName = document.getElementById("applename").textContent;
        productQuantity = Number((document.getElementById("appleqty") as HTMLInputElement).value);
        productPrice = 12.75;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    } else if (id == "pecanprod") {
        productName = document.getElementById("pecanname").textContent;
        productQuantity = Number((document.getElementById("pecanqty") as HTMLInputElement).value);
        productPrice = 17.80;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    } else if (id == "blackberryprod") {
        productName = document.getElementById("blackberryname").textContent;
        productQuantity = Number((document.getElementById("blackberryqty") as HTMLInputElement).value);
        productPrice = 14.35;
        productNumber += 1;
        console.log("Name: "+productName+ " Price $" +productPrice+" Quantity: "+productQuantity)
    }
    ...
    let prodObj = {numIndex:productNumber, name:productName, price:productPrice, quantity:productQuantity, totalprice:productCost};
...
function displayTotalAmount(){
    let amountTotal = localStorage.getItem("productArray");
    let totalJson = JSON.parse(amountTotal);
  
    for (let i=0; i < totalJson.length; i++){
            totalCost += parseFloat(totalJson[i].totalprice);
        }

    let totalStr = "Total Amount: $" + totalCost;

    document.getElementById("totalAmountDis").innerHTML= totalStr;
}

function deleteProduct(id:string){
     let getItem = localStorage.getItem("productArray");
     let productJson = JSON.parse(getItem);
